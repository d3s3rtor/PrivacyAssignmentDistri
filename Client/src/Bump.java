...
public class Bump extends JFrame implements Serializable {
    ...
    private JPasswordField passwordFieldBump;
    private JLabel bumpPassLabel;
    ...
    public Bump(Client client, onUpdate onUpdate) {
        ...
        generatBUMP.addActionListener(e -> {
            if (passwordFieldBump.getPassword().length < 1) {
                JOptionPane.showMessageDialog(panel, "Please enter the password of the BUMP file.");
            } else {
                ...
                if (response == JFileChooser.APPROVE_OPTION) {
                    ...
                    secrets = client.writeSecrets(filename, String.valueOf(passwordFieldBump.getPassword()));
                } else {
